...
\frac{\Gamma(\sum_{i=1}^kw_i+1)}{\prod_{i=1}^k\Gamma(w_i+1)} \prod_{i=1}^kp_i^{k_i} &,\text{ kun } \sum_{i=1}^{k}w_i =1 \\
0 & , \text{ muuten.}
\end{cases}
\]
...
\frac{\Gamma(\sum_{i=1}^k \alpha_i)}{\prod_{i=1}^k\Gamma(\alpha_i)} \prod_{i=1}^kw_i^{\alpha_i-1} &,\text{ kun } \sum_{i=1}^{k}w_i =1 \\
0 & , \text{ muuten.}
\end{cases}
\]
